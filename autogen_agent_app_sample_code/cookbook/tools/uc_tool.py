...
class UCTool(Tool):
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        self.name = self._toolkit.tools[0].tool["function"]["name"]
        self.description = self._toolkit.tools[0].tool["function"]["description"]
    ...
    def _get_parameters_schema(self) -> dict:
        ...
        """
        # OK to use [0] position b/c we know that there is only one function initialized in the toolkit.
        return self._toolkit.tools[0].tool["function"]["parameters"]

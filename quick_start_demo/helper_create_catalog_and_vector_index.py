...
# Uncomment if running this notebook on its own
...
# MAGIC %md
# MAGIC #### Validate UC Catalog & Schema, create if not exists
...
# MAGIC %md
# MAGIC #### Validate Vector Search endpoint, create if not exists

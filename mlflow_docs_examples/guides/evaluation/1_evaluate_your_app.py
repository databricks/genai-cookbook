...
This script contains the code from the following documentation page: https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/evaluate-app
...
print("=" * 80)
print("Guide: Evaluating a version of your app")
print("=" * 80)
...
print("\n" + "=" * 60)
print("Testing: Step 4: Run evaluation with predefined scorers")
print("=" * 60)

...
# MAGIC %md
# MAGIC # Using evaluation to improve your app's quality
# MAGIC
# MAGIC This script contains the code from the following documentation page: https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/version-comparison
# MAGIC
...
# MAGIC %pip install --upgrade "mlflow[databricks]>=3.1.0" openai "databricks-connect>=16.1" pandas
...
# MAGIC %md
# MAGIC # SECTION: Step 4: Evaluate the baseline version
...
# MAGIC %md
# MAGIC # SECTION: Step 6: Create an improved version
...
# MAGIC %md
# MAGIC # SECTION: Step 7: Evaluate the new version and compare
...
# MAGIC %md
# MAGIC # SECTION: Step 6: Compare results

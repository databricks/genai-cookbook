...
print("=" * 80)
print("Guide: 2. Create a custom scorer that wraps the guidelines judge")
print("=" * 80)
...
print("\n" + "=" * 60)
print("Testing: Step 2: Define your evalation criteria and wrap as custom scorers")
print("=" * 60)
...
print("\n" + "=" * 60)
print("Testing: Step 4: Evaluate your app using the guidelines")
print("=" * 60)

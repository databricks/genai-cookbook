...
# MAGIC %md
# MAGIC # 1. Use the prebuilt guidelines scorer
# MAGIC
...
# MAGIC %md
# MAGIC # SECTION: Step 2: Define your evaluation criteria
...
# MAGIC %md
# MAGIC # SECTION: Step 4: Evaluate your app using the custom scorers

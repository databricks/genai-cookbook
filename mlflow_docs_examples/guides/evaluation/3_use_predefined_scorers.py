...
This script contains the code from the following documentation page: https://docs.databricks.com/aws/en/mlflow3/genai/eval-monitor/predefined-judge-scorers
...
print("=" * 80)
print("Guide: Use predefined LLM scorers")
print("=" * 80)
...
print("\n" + "=" * 60)
print("Testing: Step 1: Create a sample application to evaluate")
print("=" * 60)
...
print("\n" + "=" * 60)
print("Testing: Step 2: Create a sample evaluation dataset")
print("=" * 60)
...
print("\n" + "=" * 60)
print("Testing: Step 3: Run evaluation with predefined scorers")
print("=" * 60)

...
# MAGIC %pip install -qqqq -U pypandoc_binary==1.13 databricks-vectorsearch transformers==4.41.1 torch==2.3.0 tiktoken==0.7.0 langchain-text-splitters==0.2.0 mlflow

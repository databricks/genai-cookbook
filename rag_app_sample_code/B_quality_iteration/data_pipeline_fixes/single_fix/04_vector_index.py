...
# MAGIC %pip install -U -qqqq databricks-vectorsearch pyyaml mlflow mlflow-skinny
...
# MAGIC %md # Save the necessary chain config to MLflow
# MAGIC
# MAGIC This configuraiton will be merged with the broader chain config in the evaluation notebooks.
...
chain_config = {
    ...
    "retriever_config": {
        ...
        "data_pipeline_tag": configuration["config_short_name"],
    }
}

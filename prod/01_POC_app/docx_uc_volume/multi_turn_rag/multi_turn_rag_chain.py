...
# MAGIC %pip install -qqq -U "https://ml-team-public-read.s3.us-west-2.amazonaws.com/wheels/rag-studio/staging/databricks_rag_studio-0.3.0.dev0-py3-none-any.whl" "mlflow>=2.13.1" "mlflow-skinny>=2.13.1" langchain==0.2.0 langchain_core==0.2.0 langchain_community==0.2.0 databricks-vectorsearch
...
prompt = ChatPromptTemplate.from_messages(
    [
        ...
        # Note: This chain does not currently compress the history, so very long converastions can overflow the context window.
